...
function App() {
  ...
  return (
    // <div className={`min-h-screen ${darkMode ? 'bg-gray-800' : 'bg-gradient-to-br from-blue-100 to-purple-200'} p-6`}>
    //   <button
    //     onClick={toggleMode}
    //     className={`text-white p-2 rounded-lg absolute top-4 right-4 ${darkMode ? 'bg-gray-700' : 'bg-purple-500'} transition duration-300`}
    //   >
  ...
  {/* Button positioned absolute on lg screens and up */}
  <button
    onClick={toggleMode}
